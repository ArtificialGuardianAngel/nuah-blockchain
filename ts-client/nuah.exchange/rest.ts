...
export type ExchangeMsgCancelBuyOrderResponse = object;

export type ExchangeMsgCancelSellOrderResponse = object;
...
export interface ExchangeQueryAllDenomTraceResponse {
  denomTrace?: ExchangeDenomTrace[];
...
export interface ExchangeQueryGetDenomTraceResponse {
  denomTrace?: ExchangeDenomTrace;
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/nuah/exchange/denom_trace
   */
  queryDenomTraceAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<ExchangeQueryAllDenomTraceResponse, RpcStatus>({
      path: `/nuah/exchange/denom_trace`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/nuah/exchange/denom_trace/{index}
   */
  queryDenomTrace = (index: string, params: RequestParams = {}) =>
    this.request<ExchangeQueryGetDenomTraceResponse, RpcStatus>({
      path: `/nuah/exchange/denom_trace/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
