...
import { StableSupply as typeStableSupply} from "./types"

export { MsgCancelSellOrder, MsgSendCreatePair, MsgSendBuyOrder, MsgSendSellOrder, MsgCancelBuyOrder };
...
class SDKModule {
	...
	constructor(client: IgniteClient) {		
		...
		this.structure =  {
						...
						StableSupply: getStructure(typeStableSupply.fromPartial({})),
