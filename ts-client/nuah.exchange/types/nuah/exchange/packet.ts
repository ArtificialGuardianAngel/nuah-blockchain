...
export const ExchangePacketData = {
  encode(message: ExchangePacketData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromPartial<I extends Exact<DeepPartial<ExchangePacketData>, I>>(object: I): ExchangePacketData {
    const message = createBaseExchangePacketData();
