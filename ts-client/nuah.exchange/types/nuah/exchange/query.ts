...
export interface QueryGetStableSupplyResponse {
  StableSupply: StableSupply | undefined;
}
...
export const QueryGetStableSupplyRequest = {
  encode(message: QueryGetStableSupplyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.id !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryGetStableSupplyRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGetStableSupplyRequest>, I>>(object: I): QueryGetStableSupplyRequest {
    const message = createBaseQueryGetStableSupplyRequest();
...
export const QueryGetStableSupplyResponse = {
  encode(message: QueryGetStableSupplyResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.StableSupply !== undefined) {
      StableSupply.encode(message.StableSupply, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): QueryGetStableSupplyResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): QueryGetStableSupplyResponse {
    return { StableSupply: isSet(object.StableSupply) ? StableSupply.fromJSON(object.StableSupply) : undefined };
  },

  toJSON(message: QueryGetStableSupplyResponse): unknown {
    const obj: any = {};
    message.StableSupply !== undefined
      && (obj.StableSupply = message.StableSupply ? StableSupply.toJSON(message.StableSupply) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<QueryGetStableSupplyResponse>, I>>(object: I): QueryGetStableSupplyResponse {
    const message = createBaseQueryGetStableSupplyResponse();
    message.StableSupply = (object.StableSupply !== undefined && object.StableSupply !== null)
...
export const QueryAllStableSupplyRequest = {
  encode(message: QueryAllStableSupplyRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.pagination !== undefined) {
      PageRequest.encode(message.pagination, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryAllStableSupplyRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllStableSupplyRequest>, I>>(object: I): QueryAllStableSupplyRequest {
    const message = createBaseQueryAllStableSupplyRequest();
    message.pagination = (object.pagination !== undefined && object.pagination !== null)
      ? PageRequest.fromPartial(object.pagination)
      : undefined;
...
export const QueryAllStableSupplyResponse = {
  encode(message: QueryAllStableSupplyResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryAllStableSupplyResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.StableSupply.push(StableSupply.decode(reader, reader.uint32()));
          break;
        case 2:
          message.pagination = PageResponse.decode(reader, reader.uint32());
          break;
  ...
  toJSON(message: QueryAllStableSupplyResponse): unknown {
    ...
    if (message.StableSupply) {
      obj.StableSupply = message.StableSupply.map((e) => e ? StableSupply.toJSON(e) : undefined);
    } else {
      obj.StableSupply = [];
    }
    message.pagination !== undefined
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllStableSupplyResponse>, I>>(object: I): QueryAllStableSupplyResponse {
    const message = createBaseQueryAllStableSupplyResponse();
    message.StableSupply = object.StableSupply?.map((e) => StableSupply.fromPartial(e)) || [];
    message.pagination = (object.pagination !== undefined && object.pagination !== null)
      ? PageResponse.fromPartial(object.pagination)
      : undefined;
    return message;
...
export interface Query {
  ...
  StableSupply(request: QueryGetStableSupplyRequest): Promise<QueryGetStableSupplyResponse>;
  StableSupplyAll(request: QueryAllStableSupplyRequest): Promise<QueryAllStableSupplyResponse>;
}
...
export class QueryClientImpl implements Query {
  ...
  DenomTraceAll(request: QueryAllDenomTraceRequest): Promise<QueryAllDenomTraceResponse> {
    ...
    const promise = this.rpc.request("nuah.exchange.Query", "DenomTraceAll", data);
  ...
  StableSupply(request: QueryGetStableSupplyRequest): Promise<QueryGetStableSupplyResponse> {
    ...
    const promise = this.rpc.request("nuah.exchange.Query", "StableSupply", data);
    return promise.then((data) => QueryGetStableSupplyResponse.decode(new _m0.Reader(data)));
  }

  StableSupplyAll(request: QueryAllStableSupplyRequest): Promise<QueryAllStableSupplyResponse> {
    const data = QueryAllStableSupplyRequest.encode(request).finish();
    const promise = this.rpc.request("nuah.exchange.Query", "StableSupplyAll", data);
    return promise.then((data) => QueryAllStableSupplyResponse.decode(new _m0.Reader(data)));
  }
}
