...
export const MsgCreateData = {
  encode(message: MsgCreateData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
...
export const MsgCreateDataResponse = {
  encode(_: MsgCreateDataResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgCreateDataResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MsgUpdateData = {
  encode(message: MsgUpdateData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.index !== "") {
...
export const MsgUpdateDataResponse = {
  encode(_: MsgUpdateDataResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgUpdateDataResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export class MsgClientImpl implements Msg {
  ...
  CreateData(request: MsgCreateData): Promise<MsgCreateDataResponse> {
    ...
    return promise.then((data) => MsgCreateDataResponse.decode(new _m0.Reader(data)));
  }

  UpdateData(request: MsgUpdateData): Promise<MsgUpdateDataResponse> {
    const data = MsgUpdateData.encode(request).finish();
    const promise = this.rpc.request("nuah.oracles.Msg", "UpdateData", data);
    return promise.then((data) => MsgUpdateDataResponse.decode(new _m0.Reader(data)));
  }
