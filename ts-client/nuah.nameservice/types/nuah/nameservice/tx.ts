...
export const MsgTransferName = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgTransferName>, I>>(object: I): MsgTransferName {
    const message = createBaseMsgTransferName();
    message.creator = object.creator ?? "";
    message.name = object.name ?? "";
    message.value = object.value ?? "";
...
export const MsgTransferNameResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgTransferNameResponse>, I>>(_: I): MsgTransferNameResponse {
    const message = createBaseMsgTransferNameResponse();
    return message;
  },
};
...
export const MsgCheckName = {
  encode(message: MsgCheckName, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.name !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgCheckName>, I>>(object: I): MsgCheckName {
    const message = createBaseMsgCheckName();
    message.creator = object.creator ?? "";
    message.name = object.name ?? "";
    return message;
...
export const MsgCheckNameResponse = {
  encode(message: MsgCheckNameResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.isFound !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgCheckNameResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): MsgCheckNameResponse {
    return { isFound: isSet(object.isFound) ? String(object.isFound) : "" };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<MsgCheckNameResponse>, I>>(object: I): MsgCheckNameResponse {
    const message = createBaseMsgCheckNameResponse();
...
export class MsgClientImpl implements Msg {
  ...
  TransferName(request: MsgTransferName): Promise<MsgTransferNameResponse> {
    ...
    const promise = this.rpc.request("nuah.nameservice.Msg", "TransferName", data);
  ...
  DeleteName(request: MsgDeleteName): Promise<MsgDeleteNameResponse> {
    ...
    const promise = this.rpc.request("nuah.nameservice.Msg", "DeleteName", data);
  ...
  CheckName(request: MsgCheckName): Promise<MsgCheckNameResponse> {
    ...
    return promise.then((data) => MsgCheckNameResponse.decode(new _m0.Reader(data)));
  }
}
