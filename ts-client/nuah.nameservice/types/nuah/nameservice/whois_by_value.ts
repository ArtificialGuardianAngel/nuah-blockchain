...
export const WhoisByValue = {
  encode(message: WhoisByValue, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.index !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<WhoisByValue>, I>>(object: I): WhoisByValue {
    const message = createBaseWhoisByValue();
