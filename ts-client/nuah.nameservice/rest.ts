...
export interface NameserviceMsgCheckNameResponse {
  isFound?: string;
}
...
export type NameserviceMsgTransferNameResponse = object;
...
/**
 * @title nuah/nameservice/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/nuah/nameservice/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<NameserviceQueryParamsResponse, RpcStatus>({
      path: `/nuah/nameservice/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @tags Query
   * @name QueryWhoisAll
   * @request GET:/nuah/nameservice/whois
   */
  queryWhoisAll = (
    query?: {
   ...
   * @request GET:/nuah/nameservice/whois/{index}
   */
