...
export const MsgCreateRequestBook = {
  encode(message: MsgCreateRequestBook, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.to !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgCreateRequestBook {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<MsgCreateRequestBook>, I>>(object: I): MsgCreateRequestBook {
    const message = createBaseMsgCreateRequestBook();
    message.creator = object.creator ?? "";
    message.to = object.to ?? "";
    return message;
...
export const MsgCreateRequestBookResponse = {
  encode(_: MsgCreateRequestBookResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgCreateRequestBookResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<MsgCreateRequestBookResponse>, I>>(_: I): MsgCreateRequestBookResponse {
    const message = createBaseMsgCreateRequestBookResponse();
    return message;
  },
};
...
export const MsgAcceptRequest = {
  encode(message: MsgAcceptRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.id !== 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgAcceptRequest>, I>>(object: I): MsgAcceptRequest {
    const message = createBaseMsgAcceptRequest();
    message.creator = object.creator ?? "";
...
export const MsgAcceptRequestResponse = {
  encode(_: MsgAcceptRequestResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgAcceptRequestResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<MsgAcceptRequestResponse>, I>>(_: I): MsgAcceptRequestResponse {
    const message = createBaseMsgAcceptRequestResponse();
    return message;
  },
};
...
export const MsgDeclineRequest = {
  encode(message: MsgDeclineRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.id !== 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgDeclineRequest>, I>>(object: I): MsgDeclineRequest {
    const message = createBaseMsgDeclineRequest();
    message.creator = object.creator ?? "";
    message.id = object.id ?? 0;
    return message;
...
export const MsgDeclineRequestResponse = {
  encode(_: MsgDeclineRequestResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgDeclineRequestResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<MsgDeclineRequestResponse>, I>>(_: I): MsgDeclineRequestResponse {
    const message = createBaseMsgDeclineRequestResponse();
    return message;
  },
};
...
export interface Msg {
  ...
  CreateRequestBook(request: MsgCreateRequestBook): Promise<MsgCreateRequestBookResponse>;
  AcceptRequest(request: MsgAcceptRequest): Promise<MsgAcceptRequestResponse>;
  DeclineRequest(request: MsgDeclineRequest): Promise<MsgDeclineRequestResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  CreateRequestBook(request: MsgCreateRequestBook): Promise<MsgCreateRequestBookResponse> {
    ...
    const promise = this.rpc.request("nuah.loan.Msg", "CreateRequestBook", data);
    return promise.then((data) => MsgCreateRequestBookResponse.decode(new _m0.Reader(data)));
  }

  AcceptRequest(request: MsgAcceptRequest): Promise<MsgAcceptRequestResponse> {
    const data = MsgAcceptRequest.encode(request).finish();
    const promise = this.rpc.request("nuah.loan.Msg", "AcceptRequest", data);
    return promise.then((data) => MsgAcceptRequestResponse.decode(new _m0.Reader(data)));
  }

  DeclineRequest(request: MsgDeclineRequest): Promise<MsgDeclineRequestResponse> {
    const data = MsgDeclineRequest.encode(request).finish();
    const promise = this.rpc.request("nuah.loan.Msg", "DeclineRequest", data);
    return promise.then((data) => MsgDeclineRequestResponse.decode(new _m0.Reader(data)));
  }
}
