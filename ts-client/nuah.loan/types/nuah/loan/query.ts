...
export interface QueryGetRequestBookResponse {
  requestBook: RequestBook | undefined;
}
...
export const QueryGetRequestBookRequest = {
  encode(message: QueryGetRequestBookRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.index !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryGetRequestBookRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGetRequestBookRequest>, I>>(object: I): QueryGetRequestBookRequest {
    const message = createBaseQueryGetRequestBookRequest();
...
export const QueryGetRequestBookResponse = {
  encode(message: QueryGetRequestBookResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.requestBook !== undefined) {
      RequestBook.encode(message.requestBook, writer.uint32(10).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): QueryGetRequestBookResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): QueryGetRequestBookResponse {
    return { requestBook: isSet(object.requestBook) ? RequestBook.fromJSON(object.requestBook) : undefined };
  },

  toJSON(message: QueryGetRequestBookResponse): unknown {
    const obj: any = {};
    message.requestBook !== undefined
      && (obj.requestBook = message.requestBook ? RequestBook.toJSON(message.requestBook) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<QueryGetRequestBookResponse>, I>>(object: I): QueryGetRequestBookResponse {
    const message = createBaseQueryGetRequestBookResponse();
    message.requestBook = (object.requestBook !== undefined && object.requestBook !== null)
...
export const QueryAllRequestBookRequest = {
  encode(message: QueryAllRequestBookRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryAllRequestBookRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllRequestBookRequest>, I>>(object: I): QueryAllRequestBookRequest {
    const message = createBaseQueryAllRequestBookRequest();
...
export const QueryAllRequestBookResponse = {
  encode(message: QueryAllRequestBookResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryAllRequestBookResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: QueryAllRequestBookResponse): unknown {
    ...
    if (message.requestBook) {
      obj.requestBook = message.requestBook.map((e) => e ? RequestBook.toJSON(e) : undefined);
    } else {
      obj.requestBook = [];
    }
    message.pagination !== undefined
  ...
  fromPartial<I extends Exact<DeepPartial<QueryAllRequestBookResponse>, I>>(object: I): QueryAllRequestBookResponse {
    const message = createBaseQueryAllRequestBookResponse();
    message.requestBook = object.requestBook?.map((e) => RequestBook.fromPartial(e)) || [];
    message.pagination = (object.pagination !== undefined && object.pagination !== null)
...
export const QueryGetMadenRequestsRequest = {
  encode(message: QueryGetMadenRequestsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.from !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryGetMadenRequestsRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromPartial<I extends Exact<DeepPartial<QueryGetMadenRequestsRequest>, I>>(object: I): QueryGetMadenRequestsRequest {
    const message = createBaseQueryGetMadenRequestsRequest();
...
export const QueryGetMadenRequestsResponse = {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): QueryGetMadenRequestsResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export interface Query {
  ...
  RequestBook(request: QueryGetRequestBookRequest): Promise<QueryGetRequestBookResponse>;
  RequestBookAll(request: QueryAllRequestBookRequest): Promise<QueryAllRequestBookResponse>;
  /** Queries a list of GetMadenRequests items. */
  GetMadenRequests(request: QueryGetMadenRequestsRequest): Promise<QueryGetMadenRequestsResponse>;
}
...
export class QueryClientImpl implements Query {
  ...
  RequestBook(request: QueryGetRequestBookRequest): Promise<QueryGetRequestBookResponse> {
    ...
    return promise.then((data) => QueryGetRequestBookResponse.decode(new _m0.Reader(data)));
  }
  ...
  RequestBookAll(request: QueryAllRequestBookRequest): Promise<QueryAllRequestBookResponse> {
    ...
    return promise.then((data) => QueryAllRequestBookResponse.decode(new _m0.Reader(data)));
  }

  GetMadenRequests(request: QueryGetMadenRequestsRequest): Promise<QueryGetMadenRequestsResponse> {
    const data = QueryGetMadenRequestsRequest.encode(request).finish();
    const promise = this.rpc.request("nuah.loan.Query", "GetMadenRequests", data);
    return promise.then((data) => QueryGetMadenRequestsResponse.decode(new _m0.Reader(data)));
  }
}
