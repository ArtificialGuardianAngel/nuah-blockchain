...
func (*MsgCancelSellOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_6eb71e8aab3c0bbb, []int{6}
}
...
func (*MsgCancelSellOrderResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6eb71e8aab3c0bbb, []int{7}
}
...
func (*MsgCancelBuyOrder) Descriptor() ([]byte, []int) {
	return fileDescriptor_6eb71e8aab3c0bbb, []int{8}
}
...
func (*MsgCancelBuyOrderResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6eb71e8aab3c0bbb, []int{9}
}
...
func init() {
	...
	proto.RegisterType((*MsgCancelSellOrder)(nil), "nuah.exchange.MsgCancelSellOrder")
	proto.RegisterType((*MsgCancelSellOrderResponse)(nil), "nuah.exchange.MsgCancelSellOrderResponse")
	proto.RegisterType((*MsgCancelBuyOrder)(nil), "nuah.exchange.MsgCancelBuyOrder")
	proto.RegisterType((*MsgCancelBuyOrderResponse)(nil), "nuah.exchange.MsgCancelBuyOrderResponse")
}
...
func (c *msgClient) CancelSellOrder(ctx context.Context, in *MsgCancelSellOrder, opts ...grpc.CallOption) (*MsgCancelSellOrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nuah.exchange.Msg/CancelSellOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CancelBuyOrder(ctx context.Context, in *MsgCancelBuyOrder, opts ...grpc.CallOption) (*MsgCancelBuyOrderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/nuah.exchange.Msg/CancelBuyOrder", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CancelSellOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nuah.exchange.Msg/CancelSellOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_CancelBuyOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/nuah.exchange.Msg/CancelBuyOrder",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
