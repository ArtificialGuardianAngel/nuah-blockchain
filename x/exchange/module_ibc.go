...
func (im IBCModule) OnRecvPacket(
	...
	var modulePacketData types.ExchangePacketData
	...
	case *types.ExchangePacketData_CreatePairPacket:
	...
	case *types.ExchangePacketData_SellOrderPacket:
	...
	case *types.ExchangePacketData_BuyOrderPacket:
