...
export const MsgSendCreatePair = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgSendCreatePair>, I>>(
    object: I
  ): MsgSendCreatePair {
    const message = createBaseMsgSendCreatePair();
...
export const MsgSendCreatePairResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgSendCreatePairResponse>, I>>(
    _: I
  ): MsgSendCreatePairResponse {
    const message = createBaseMsgSendCreatePairResponse();
    return message;
...
export const MsgCancelBuyOrder = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgCancelBuyOrder>, I>>(
    object: I
  ): MsgCancelBuyOrder {
    const message = createBaseMsgCancelBuyOrder();
    message.creator = object.creator ?? "";
...
export const MsgCancelBuyOrderResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<MsgCancelBuyOrderResponse>, I>>(
    _: I
  ): MsgCancelBuyOrderResponse {
    const message = createBaseMsgCancelBuyOrderResponse();
    return message;
...
export class MsgClientImpl implements Msg {
  ...
  SendCreatePair(
    ...
    return promise.then((data) =>
      MsgSendCreatePairResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  CancelBuyOrder(
    ...
    return promise.then((data) =>
      MsgCancelBuyOrderResponse.decode(new _m0.Reader(data))
    );
  }
}
