...
export const RequestBook = {
  ...
  fromJSON(object: any): RequestBook {
    return {
      ...
      book: isSet(object.book)
        ? RequestBookItem.fromJSON(object.book)
        : undefined,
    };
  },
  ...
  toJSON(message: RequestBook): unknown {
    ...
    message.book !== undefined &&
      (obj.book = message.book
        ? RequestBookItem.toJSON(message.book)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<RequestBook>, I>>(
    object: I
  ): RequestBook {
    const message = createBaseRequestBook();
