...
function createBaseGenesisState(): GenesisState {
  return { params: undefined, portId: "", dataList: [] };
}
...
export const GenesisState = {
  encode(
    ...
    for (const v of message.dataList) {
      Data.encode(v!, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      dataList: Array.isArray(object?.dataList)
        ? object.dataList.map((e: any) => Data.fromJSON(e))
        : [],
    };
  },
