...
function createBaseDexPacketData(): DexPacketData {
  return {
    ...
    sellOrderPacket: undefined,
    buyOrderPacket: undefined,
  };
}
  ...
  fromJSON(object: any): DexPacketData {
    return {
      ...
      createPairPacket: isSet(object.createPairPacket)
        ...
        : undefined,
      sellOrderPacket: isSet(object.sellOrderPacket)
        ? SellOrderPacketData.fromJSON(object.sellOrderPacket)
        : undefined,
      buyOrderPacket: isSet(object.buyOrderPacket)
        ? BuyOrderPacketData.fromJSON(object.buyOrderPacket)
        : undefined,
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<DexPacketData>, I>>(
    ...
    message.noData =
      object.noData !== undefined && object.noData !== null
        ...
        : undefined;
    message.createPairPacket =
      object.createPairPacket !== undefined && object.createPairPacket !== null
        ? CreatePairPacketData.fromPartial(object.createPairPacket)
        : undefined;
    message.sellOrderPacket =
      object.sellOrderPacket !== undefined && object.sellOrderPacket !== null
        ? SellOrderPacketData.fromPartial(object.sellOrderPacket)
        : undefined;
    message.buyOrderPacket =
      object.buyOrderPacket !== undefined && object.buyOrderPacket !== null
...
export const CreatePairPacketData = {
  ...
  fromPartial<I extends Exact<DeepPartial<CreatePairPacketData>, I>>(
    object: I
  ): CreatePairPacketData {
    const message = createBaseCreatePairPacketData();
...
export const CreatePairPacketAck = {
  ...
  fromPartial<I extends Exact<DeepPartial<CreatePairPacketAck>, I>>(
    _: I
  ): CreatePairPacketAck {
    const message = createBaseCreatePairPacketAck();
    return message;
...
export const SellOrderPacketData = {
  ...
  fromPartial<I extends Exact<DeepPartial<SellOrderPacketData>, I>>(
    object: I
  ): SellOrderPacketData {
    const message = createBaseSellOrderPacketData();
...
export const SellOrderPacketAck = {
  ...
  fromJSON(object: any): SellOrderPacketAck {
    return {
      remainingAmount: isSet(object.remainingAmount)
        ? Number(object.remainingAmount)
        : 0,
  ...
  fromPartial<I extends Exact<DeepPartial<SellOrderPacketAck>, I>>(
    object: I
  ): SellOrderPacketAck {
    const message = createBaseSellOrderPacketAck();
...
export const BuyOrderPacketData = {
  ...
  fromPartial<I extends Exact<DeepPartial<BuyOrderPacketData>, I>>(
    object: I
  ): BuyOrderPacketData {
    const message = createBaseBuyOrderPacketData();
    message.amountDenom = object.amountDenom ?? "";
...
export const BuyOrderPacketAck = {
  ...
  fromPartial<I extends Exact<DeepPartial<BuyOrderPacketAck>, I>>(
    object: I
  ): BuyOrderPacketAck {
    const message = createBaseBuyOrderPacketAck();
    message.remainingAmount = object.remainingAmount ?? 0;
